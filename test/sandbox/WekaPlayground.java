...
public class WekaPlayground {
	...
	public static void main(String[] args) throws Exception {
		...
		Instances data = DataSource
				.read("files/chinese_tonestudy_datashop2.csv");

		Attribute classAttribute = new Attribute("Outcome");
		...
		for (int n = 0; n < folds; n++) {
			...
			Classifier clsCopy = Classifier.makeCopy(forest);
		...
		System.out.println("Classifier: " + forest.getClass().getName() + " "
				+ Utils.joinOptions(forest.getOptions()));
